...
export const updateSchool = async (datavalues) => {
    try {
        const [results] = await pool.query("UPDATE school  SET ngo = ?, schoolcode = ?,  schoolname = ?, kschoolname = ?, addressline1 = ?, addressline2 = ?, village = ?, taluka = ?, district = ?, pincode = ?, route = ?, contactno = ?, headmastername = ?, headmasterno = ?, headmasteremail = ?, 1std_female = ?, 1std_male = ?, 1std = ?, 2std_female = ?, 2std_male = ?, 2std = ?, 3std_female = ?, 3std_male = ?, 3std = ?, 4std_female = ?, 4std_male = ?, 4std = ?, 5std_female = ?, 5std_male = ?, 5std = ?, 6std_female = ?, 6std_male = ?, 6std = ?, 7std_female = ?, 7std_male = ?, 7std = ?, 8std_female = ?, 8std_male = ?, 8std = ?, 9std_female = ?, 9std = ?, 10std_female = ?, 10std_male = ?, 10std = ?, updatedBy = ?, updatedtime = NOW() WHERE oid = ?", Object.values(datavalues));
